...
int32_t HdiConnection::ConnectHdi()
{
    ...
    HiSysEvent::Write(HiviewDFX::HiSysEvent::Domain::SENSORS_MISCDEVICE, "VIBRATOR_HDF_SERVICE_EXCEPTION",
...
int32_t HdiConnection::StartOnce(uint32_t duration)
{
    ...
    if (ret < 0) {
        HiSysEvent::Write(HiSysEvent::Domain::SENSORS_MISCDEVICE, "VIBRATOR_HDF_SERVICE_EXCEPTION",
