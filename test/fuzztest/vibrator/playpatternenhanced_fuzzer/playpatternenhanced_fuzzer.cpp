...
#include "playpatternenhanced_fuzzer.h"
...
namespace {
constexpr size_t U32_AT_SIZE = 20;
} // namespace
...
void SetUpTestCase()
{
    ...
    TokenInfoParams infoInstance = {
        ...
        .perms = perms,
        .acls = nullptr,
        .processName = "PlayPatternEnhancedFuzzTest",
        .aplStr = "system_core",
    };
...
bool PlayPatternEnhancedFuzzTest(const uint8_t *data, size_t size)
{
    ...
    int32_t ret = OHOS::Sensors::PlayPatternEnhanced(identifier, vibratorPattern);
    return ret == 0;
}
} // namespace OHOS
...
{
    OHOS::PlayPatternEnhancedFuzzTest(data, size);
    return 0;
}