...
#include "setparametersenhanced_fuzzer.h"
...
bool SetParametersEnhancedFuzzTest(const uint8_t *data, size_t size)
{
    ...
    return OHOS::Sensors::SetParametersEnhanced(identifier, parameter);
}
} // namespace OHOS

extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    OHOS::SetParametersEnhancedFuzzTest(data, size);
    return 0;
}