...
#include "getdelaytimeenhanced_fuzzer.h"
...
void SetUpTestCase()
{
    ...
    TokenInfoParams infoInstance = {
        ...
        .perms = perms,
        .acls = nullptr,
        .processName = "GetDelayTimeEnhancedFuzzTest",
        .aplStr = "system_core",
    };
...
bool GetDelayTimeEnhancedFuzzTest(const uint8_t *data, size_t size)
{
    ...
    int32_t ret = OHOS::Sensors::GetDelayTimeEnhanced(identifier, delayTime);
    if (ret == 0) {
        return false;
    }
    return true;
...
{
    OHOS::GetDelayTimeEnhancedFuzzTest(data, size);
    return 0;
}