...
#include "issupportvibratorcustom_fuzzer.h"
...
void IsSupportVibratorCustomFuzzTest(const uint8_t *data, size_t size)
{
...
{
    OHOS::Sensors::IsSupportVibratorCustomFuzzTest(data, size);
    return 0;
}