...
#include "getdelaytimestub_fuzzer.h"
...
void SetUpTestCase()
{
    ...
    TokenInfoParams infoInstance = {
        ...
        .perms = perms,
        .acls = nullptr,
        .processName = "GetDelayTimeStubFuzzTest",
        .aplStr = "system_core",
    };
...
bool OnRemoteRequestFuzzTest(const uint8_t *data, size_t size)
{
    ...
    g_service->OnRemoteRequest(static_cast<uint32_t>(MiscdeviceInterfaceCode::GET_DELAY_TIME),
        datas, reply, option);
    return true;
}
}  // namespace Sensors
