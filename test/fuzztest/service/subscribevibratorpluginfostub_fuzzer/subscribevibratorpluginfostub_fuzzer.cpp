...
#include "subscribevibratorpluginfostub_fuzzer.h"
...
bool OnRemoteRequestFuzzTest(const uint8_t *data, size_t size)
{
    ...
    g_service->OnRemoteRequest(static_cast<uint32_t>(IMiscdeviceServiceIpcCode::COMMAND_SUBSCRIBE_VIBRATOR_PLUG_INFO),
        datas, reply, option);
    return true;
}
} // namespace Sensors
